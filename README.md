...
| Architecture Characteristic      | Rationale                                                                                                                                                                                                                                                                                   | Reference to requirements                                                                                   | Impact on architecture |
|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|---|
| **Feasibility (cost/time)**      | This is an implicit characteristic that takes into account the tight time frame and budget to implement a product MVP.                                                                                                                                                                      | *"A new startup wants to build..."*                                                                         | The architecture must be flexible and extensible and we must us standard and (where possible) open source components |
| **Scalability** / **Elasticity** | The system capacity will significantly grow over time, and the number of users and requests will increase respectively. Also, we anticipate spikes of user activity on weekends and cool down on working days, so system should be also elastic enough to scale not only up, but also down. | *"2 million active users/week... 15 million total accounts"*                                                | See ADR.8 [CQRS and scalability](ADRs/cqrs.md) |
| **Availability**                 | There is a strict requirement on the amount of uptime of the system.                                                                                                                                                                                                                        | *"max 5 minutes per month of unplanned downtime"*                                                           | See ADR.4 [High Availability and Disaster Recovery](ADRs/hadr.md) and ADR.5 [Cloud Deployment](ADRs/cloud-deployment.md) |
| **Responsiveness**               | There is a strict requirement on the amount of time it takes to get a response to the user.                                                                                                                                                                                                 | *"Response time from web (800ms) and mobile (First-contentful paint of under 1.4 sec)"*                     | See ADR.3 [Responsiveness (Caching)](ADRs/responsiveness.md) |
| **Interoperability**             | The system must be integrated with a large number of third-party system to capture the reservation data.                                                                                                                                                                                    | *"must integrate seamlessly with existing travel systems..."*                                               | See ADR.2 [E-mail Processing](ADRs/email-processing.md) and ADR.6 [Event bus](ADRs/event-bus.md) |
| **Extensibility**                | The system will be gradually extended with more types of reservations and more data sources.                                                                                                                                                                                                | *"The system must interface with the agency’s existing airline, hotel, and car rental interface system..."* | See ADR.7 [Efficient data storage](ADRs/efficient-data-storage.md) |
